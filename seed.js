...
async function run(){
  ...
  const d1 = { hospitalId: 'CG04AIIMSRAIPUR', doctorId: 'CG0890', name: 'Dr. Lakshya Kumar Mandavi', qualification: 'MBBS, MS', speciality: 'Surgeon', experience: '5 years', password: 'test@1234', forcePasswordChange: true };
  const d2 = { hospitalId: 'CG04AIIMSRAIPUR', doctorId: 'CG0891', name: 'Dr. Priya Sharma', qualification: 'MBBS, MD', speciality: 'Cardiologist', experience: '8 years', password: 'test@1234', forcePasswordChange: true };
  const d3 = { hospitalId: 'CG04AIIMSRAIPUR', doctorId: 'CG0892', name: 'Dr. Rajesh Verma', qualification: 'MBBS, DM', speciality: 'Neurologist', experience: '12 years', password: 'test@1234', forcePasswordChange: true };
  
  // Doctors for Apollo Bangalore
  const d4 = { hospitalId: 'KA01APOLLOBLR', doctorId: 'KA1001', name: 'Dr. Suresh Kumar', qualification: 'MBBS, MD, DM', speciality: 'Oncologist', experience: '15 years', password: 'test@1234', forcePasswordChange: true };
  const d5 = { hospitalId: 'KA01APOLLOBLR', doctorId: 'KA1002', name: 'Dr. Meera Reddy', qualification: 'MBBS, MS', speciality: 'Orthopedic Surgeon', experience: '10 years', password: 'test@1234', forcePasswordChange: true };
  
  // Doctors for Fortis Delhi
  const d6 = { hospitalId: 'DL07FORTISVASANT', doctorId: 'DL2001', name: 'Dr. Amit Singh', qualification: 'MBBS, MD, DM', speciality: 'Cardiologist', experience: '18 years', password: 'test@1234', forcePasswordChange: true };
  
  await Doctor.collection.insertMany([d1, d2, d3, d4, d5, d6], { bypassDocumentValidation: true });

  // Ambulances for AIIMS Raipur
  const a1 = { hospitalId: 'CG04AIIMSRAIPUR', ambulanceId: '108AMB01', ambulanceNumber: 'CG04-1234', vehicleNumber: 'CG04AB1234', emt: { name: 'Ravi Kumar', mobile: '9876543210', emtId: 'EMT001' }, pilot: { name: 'Vikram Singh', mobile: '9876543211', pilotId: 'PIL001' }, password: 'test@1234', forcePasswordChange: true, status: 'Offline' };
  const a2 = { hospitalId: 'CG04AIIMSRAIPUR', ambulanceId: '108AMB02', ambulanceNumber: 'CG04-5678', vehicleNumber: 'CG04CD5678', emt: { name: 'Suresh Yadav', mobile: '9876543212', emtId: 'EMT002' }, pilot: { name: 'Ramesh Patel', mobile: '9876543213', pilotId: 'PIL002' }, password: 'test@1234', forcePasswordChange: true, status: 'Offline' };
  
  // Ambulances for Apollo Bangalore
  const a3 = { hospitalId: 'KA01APOLLOBLR', ambulanceId: 'KA108A01', ambulanceNumber: 'KA01-9876', vehicleNumber: 'KA01EF9876', emt: { name: 'Ganesh Naik', mobile: '9988776655', emtId: 'EMT101' }, pilot: { name: 'Krishna Rao', mobile: '9988776656', pilotId: 'PIL101' }, password: 'test@1234', forcePasswordChange: true, status: 'Offline' };
  
  // Ambulances for Fortis Delhi
  const a4 = { hospitalId: 'DL07FORTISVASANT', ambulanceId: 'DL102A01', ambulanceNumber: 'DL07-4321', vehicleNumber: 'DL07GH4321', emt: { name: 'Manoj Kumar', mobile: '9911223344', emtId: 'EMT201' }, pilot: { name: 'Sanjay Gupta', mobile: '9911223345', pilotId: 'PIL201' }, password: 'test@1234', forcePasswordChange: true, status: 'Offline' };
  ...
  console.log('   CG0890 - Dr. Lakshya Kumar Mandavi (Surgeon) - Password: test@1234');
  console.log('   CG0891 - Dr. Priya Sharma (Cardiologist) - Password: test@1234');
  console.log('   CG0892 - Dr. Rajesh Verma (Neurologist) - Password: test@1234\n');
  
  console.log('Apollo Bangalore Doctors:');
  console.log('   KA1001 - Dr. Suresh Kumar (Oncologist) - Password: test@1234');
  console.log('   KA1002 - Dr. Meera Reddy (Orthopedic Surgeon) - Password: test@1234\n');
  
  console.log('Fortis Delhi Doctors:');
  console.log('   DL2001 - Dr. Amit Singh (Cardiologist) - Password: test@1234\n');
